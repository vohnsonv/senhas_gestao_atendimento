...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(pos.com.cn.bluetooth.sdk.Main_Activity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(pos.com.cn.bluetooth.sdk.Main_Activity.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(pos.com.cn.bluetooth.sdk.Main_Activity.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(pos.com.cn.bluetooth.sdk.Main_Activity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(pos.com.cn.bluetooth.sdk.Main_Activity.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(pos.com.cn.bluetooth.sdk.Main_Activity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(pos.com.cn.bluetooth.sdk.Main_Activity.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    private void stopView() {
        // Send a failure message back to the Activity
        Message msg = mHandler.obtainMessage(pos.com.cn.bluetooth.sdk.Main_Activity.MESSAGE_STOP_VIEW);
        Bundle bundle = new Bundle();
        bundle.putString(pos.com.cn.bluetooth.sdk.Main_Activity.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
